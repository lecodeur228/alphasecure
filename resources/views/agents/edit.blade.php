...
<div class="app-wrapper">
    ...
    <div class="app-content pt-3 p-md-3 p-lg-4">
        <div class="container-xl">
            <h1 class="app-page-title">Modifier un Agent</h1>
            <hr class="mb-4">
                ...
                <div class="col-12 col-md-8">
                    <div class="app-card app-card-settings shadow-sm p-4">
                        <div class="app-card-body">
                            ...
                            <form class="settings-form" method="POST" action="{{ route('agents.update', $agent->id) }}">
                                @csrf
                                @method('PUT')
                                ...
                                <div class="mb-3">
                                    ...
                                    <input type="text" class="form-control @error('nom') is-invalid @enderror" id="nom" name="nom" value="{{ old('nom', $agent->nom) }}">
                                    @error('nom')
                                        <div class="invalid-feedback">
                                            {{ $message }}
                                        </div>
                                ...
                                <div class="mb-3">
                                    ...
                                    <select class="form-select @error('disponibilite') is-invalid @enderror" id="disponibilite" name="disponibilite">
                                        ...
                                        <option value="1" {{ old('disponibilite', $agent->disponibilite) == '1' ? 'selected' : '' }}>Disponible</option>
                                        <option value="0" {{ old('disponibilite', $agent->disponibilite) == '0' ? 'selected' : '' }}>Non disponible</option>
                                    </select>
                                    @error('disponibilite')
                                        <div class="invalid-feedback">
                                            {{ $message }}
                                ...
                                <div class="mb-3">
                                    ...
                                    <input type="text" class="form-control @error('photo') is-invalid @enderror" id="photo" name="photo" value="{{ old('photo', $agent->photo) }}">
                                    @error('photo')
                                        <div class="invalid-feedback">
                                            {{ $message }}
                                        </div>
